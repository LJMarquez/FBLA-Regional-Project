...
if (document.body.contains(job1Container)) {
    job1Container.addEventListener('click', function() {
        job1Container.style.border = ".3vw solid #7A9AE4";
        job2Container.style.border = ".3vw solid white";
        job3Container.style.border = ".3vw solid white";

        jobApply1.style.display = "block";
        jobInfo1.style.display = "block";
    
        jobApply2.style.display = "none";
        jobApply3.style.display = "none";
    ...
    job2Container.addEventListener('click', function() {
        job2Container.style.border = ".3vw solid #7A9AE4";
        job1Container.style.border = ".3vw solid white";
        job3Container.style.border = ".3vw solid white";
    
        jobApply2.style.display = "block";
        jobInfo2.style.display = "block";
    
        jobApply1.style.display = "none";
        jobApply3.style.display = "none";
    ...
    job3Container.addEventListener('click', function() {
        job3Container.style.border = ".3vw solid #7A9AE4";
        job1Container.style.border = ".3vw solid white";
        job2Container.style.border = ".3vw solid white";
    
        jobApply3.style.display = "block";
